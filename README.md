...
> 可运行的开源示例项目，业务场景为电商售后客服，覆盖订单/物流/退款查询、政策问答与工单生成等完整流程。
...
> 因此，如果你想开放一个免费 Demo 给别人体验，**不需要**把任何 Key 放进云端 Secrets——访问者用自己的 Key 即可。
...
想让更多人**点链接直接体验**，可用 [Streamlit Community Cloud](https://share.streamlit.io/)（免费，需 GitHub 账号）。
...
| 场景 | 做法 |
|---|---|
| 公开 Demo（多人体验） | 部署者**不配** Secrets，访问者填自己的 Key，零额度风险 |
...
- 免费版对同一账号的总资源有配额，适合轻量演示，不适合高并发生产使用。
